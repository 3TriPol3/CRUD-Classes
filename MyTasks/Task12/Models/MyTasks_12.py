...
from MyTasks.Task12.Models.BaseModel import *

class ProjectsList(BaseModel): # Этот класс наследует базовую модель - BaseModel
    '''
...
if __name__ == "__main__":
    mysql_db.create_tables([ProjectsList])